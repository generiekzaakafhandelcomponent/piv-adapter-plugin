...
2. Rename the PIV Adapter plugin package, module, and configuration to match your plugin
...
- [PIV Adapter Plugin](documentation/plugin.md) — reference implementation included in this template
