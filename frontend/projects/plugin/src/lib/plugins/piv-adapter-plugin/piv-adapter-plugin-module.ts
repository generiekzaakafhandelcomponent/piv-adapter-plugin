...
@NgModule({
  declarations: [PivAdapterPluginConfigurationComponent, PivUittrekselAanvraagConfigurationComponent],
  imports: [
    CommonModule,
  ...
  exports: [PivAdapterPluginConfigurationComponent, PivUittrekselAanvraagConfigurationComponent],
})
export class PivAdapterPluginModule {
}